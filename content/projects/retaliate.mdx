---
title: "Retaliate"
description: "A lightweight React-like UI library with a custom virtual DOM, component lifecycle, and JSX transpilation via esbuild — built to understand how frameworks work under the hood."
